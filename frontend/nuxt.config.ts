  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: "og:title", content: "TrailFood Library" },
        { property: "og:site_name", content: "TrailFood Library" },
        {
          property: "og:description",
          content: "TrailFood Library is a recipe management app for your kitchen.",
        },
        {
          property: "og:image",
          content:
